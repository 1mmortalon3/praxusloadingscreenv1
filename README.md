...
Static Garry's Mod loading screen prepared for GitHub Pages. It includes the animated Revan MP4 background, a two-track music playlist, responsive JVS styling, and Garry's Mod loading callbacks.
...
Keep `index.html`, `styles.css`, `script.js`, `.nojekyll`, and the entire `assets` folder together. The relative paths are already compatible with both project Pages and custom domains.
